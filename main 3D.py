"""
1. Пирамида вращается неадекватно!!!  Видимо следует поменять местами углы по х и у
2. Нужно добавить возможность перемещения камеры (простой сдвиг), для этого:
	- отслеживать события нажатия на правую кнопку мыши, при этом регистрируя координату нажатия
	- отслеживать события перетаскивания мыши с нажатой правок кнопкой, изменять xoffset yoffset соответственно
	- в glTranslate использовать xoffset yoffset в качестве смещения по х и y
	- контролировать отпускание мыши
